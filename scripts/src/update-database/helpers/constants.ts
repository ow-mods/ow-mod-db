export const DATABASE_REPO_OWNER = "ow-mods";

export const DATABASE_REPO = {
  owner: "ow-mods",
  repo: "ow-mod-db",
};
...
export const THUMBNAIL_URL_BASE = `https://raicuparta.github.io/ow-mod-db-staging/thumbnails`;
